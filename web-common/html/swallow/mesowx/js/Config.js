...
mesowx.Config = (function() {
    ...
    Config.fieldDefaults = {
        ...
        'outTemp':          new meso.FieldDef('outTemp',        mesowx.Unit.c,          1,      meso.Agg.avg,   'Temperature'),
        'rainRate':         new meso.FieldDef('deltarain',      mesowx.Unit.mmHr,       1,      meso.Agg.max,   'Rain Index'),
        'dayRain':          new meso.FieldDef('dayRain',        mesowx.Unit.mm,         1,      meso.Agg.max,   'Rain Today'),
        'windSpeed':        new meso.FieldDef('windSpeed',      mesowx.Unit.mps,        0,      meso.Agg.avg,   'Wind Speed'),
        'windDir':          new meso.FieldDef('windDir',        mesowx.Unit.deg,        0,      meso.Agg.avg,   'Wind Direction'),
        'maxWind':          new meso.FieldDef('maxWind',        mesowx.Unit.mps,        1,      meso.Agg.avg,   'Wind Gust'),
        'outHumidity':      new meso.FieldDef('outHumidity',    mesowx.Unit.perc,       0,      meso.Agg.avg,   'Humidity'),
        'barometer':        new meso.FieldDef('pressure',       mesowx.Unit.mmHg,       0,      meso.Agg.avg,   'Pressure'),
        'inTemp':           new meso.FieldDef('inTemp',         mesowx.Unit.c,          1,      meso.Agg.avg,   'Int. Temp.'),
        'illumination':     new meso.FieldDef('illumination',   mesowx.Unit.lux,        0,      meso.Agg.avg,   'Light'),
        'geiger':           new meso.FieldDef('geiger',         mesowx.Unit.cpm,        0,      meso.Agg.avg,   'γ-Radiation'),
        'downfall':         new meso.FieldDef('downfall',       mesowx.Unit.boool,      0,      meso.Agg.avg,   'Precipitation')
    };
